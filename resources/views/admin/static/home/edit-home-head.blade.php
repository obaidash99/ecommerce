...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('update-home-head/' . $static_head->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                @if ($errors->any())
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="title" id="heading_title" value="{{ $static_head->title }}" class="form-control border p-2">
                    </div>
                    <div class="col-md-12 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="btn_1_content" id="heading_btn_1" value="{{ $static_head->btn_1_content }}" class="form-control border p-2">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="heading_btn_2">Second Button Text</label>
                        <input type="text" name="btn_2_content" id="heading_btn_2" value="{{ $static_head->btn_2_content }}" class="form-control border p-2">
                    </div>
                    <div class="col-md-12 mb-3">
